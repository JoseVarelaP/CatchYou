...
\lstinputlisting[caption = Codigo de busqueda de busqueda del enemigo 3 y 4.]{cod/bps-code.gd}
...
\lstinputlisting[caption = Codigo de expansion de busqueda del enemigo 2 (Greedy).]{cod/expand-greedy.gd}
